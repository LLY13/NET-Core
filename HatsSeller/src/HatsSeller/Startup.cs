...
using HatsSeller.Services;
using Microsoft.AspNetCore.Identity;

namespace HatsSeller
{
...
HatContext context, IServiceProvider serviceProvider, ApplicationDbContext apContext, UserManager<ApplicationUser> userManager)
        {
            app.UseSession();
